...
local aa = {
    ...
    [50] = function()
    -- Giữ nguyên phần b(50) nếu lib của bạn cần
    local aa, ab, ac, ad, ae = b(50)

    return {
        Name               = "Dark",                     -- Tên theme
        -- ★ Màu nhấn & viền
        Accent             = Color3.fromRGB(0, 178, 224),   -- Cyan  (chữ tiêu đề, icon, v.v.)
        TitleBarLine       = Color3.fromRGB(0, 178, 224),
        AcrylicBorder      = Color3.fromRGB(0, 178, 224),

        -- ★ Nền & khung
        AcrylicMain        = Color3.fromRGB(40, 40, 40),    -- Nền panel
        ...
        -- ★ Tab/thanh chọn bên trái
        Tab                = Color3.fromRGB(0, 255, 0),     -- Vạch xanh lá chạy dọc tab chọn

        -- ★ Khối phần tử
        Element            = Color3.fromRGB(55, 55, 55),    -- Nền item (ô toggle, dropdown…)
        ElementBorder      = Color3.fromRGB(25, 25, 25),
        InElementBorder    = Color3.fromRGB(90, 90, 90),
        ElementTransparency= 0.87,

        -- ★ Toggle
        ToggleSlider       = Color3.fromRGB(236, 44, 47),   -- Đỏ khi TẮT
        ToggleToggled      = Color3.fromRGB(0, 255, 0),     -- Xanh lá khi BẬT
        SliderRail         = Color3.fromRGB(100, 100, 100),

        -- ★ Dropdown
        DropdownFrame      = Color3.fromRGB(50, 180, 45),   -- Nền ô dropdown đang chọn
        DropdownHolder     = Color3.fromRGB(64, 64, 64),    -- Nền list
        DropdownBorder     = Color3.fromRGB(25, 25, 25),
        DropdownOption     = Color3.fromRGB(255, 230, 70),  -- Mũi tên / option highlight (vàng)
        ...
        -- ★ Văn bản
        Text               = Color3.fromRGB(0, 178, 224),   -- Chữ chính (Cày, Sự Kiện…)
        SubText            = Color3.fromRGB(200, 200, 200), -- Chữ phụ / mô tả
