...
local aa = {
    ...
    return {
        ...
        AcrylicGradient    = ColorSequence.new(Color3.fromRGB(45, 45, 45),
                                               Color3.fromRGB(45, 45, 45)),
        AcrylicNoise       = 0.9,

        -- ★ TAB BÊN TRÁI (vạch màu xanh lá theo ảnh gốc)
        Tab                = Color3.fromRGB(0, 255, 0),
        ...
        -- ★ TOGGLE
        ToggleSlider       = Color3.fromRGB(236, 44, 47),   -- Đỏ khi OFF
        ToggleToggled      = Color3.fromRGB(0, 255, 0),     -- Xanh lá khi ON
        SliderRail         = Color3.fromRGB(100, 100, 100),

        -- ★ DROPDOWN
        DropdownFrame      = Color3.fromRGB(50, 180, 45),
        DropdownHolder     = Color3.fromRGB(64, 64, 64),
        DropdownBorder     = Color3.fromRGB(25, 25, 25),
        DropdownOption     = Color3.fromRGB(255, 230, 70),
